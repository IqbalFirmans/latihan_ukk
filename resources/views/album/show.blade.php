        ...
        <div class="flex justify-between">
            ...
            <div class="relative right-10">
                <button id="dropdownMenuIconHorizontalButton" data-dropdown-toggle="dropdownDotsHorizontal"
                    ...
                    type="button">
                    <svg class="w-8 h-8 focus:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div id="dropdownDotsHorizontal"
                ...
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownMenuIconHorizontalButton">
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100">Edit Album</a>
                    </li>
                    <li>
                        <a data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                            class="block px-4 py-2 hover:bg-gray-100">Delete Album</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="group relative cursor-pointer rounded-lg">
                        <a href="{{ route('post.show', $post->id) }}" class="block">
                            ...
                            <div class="absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
                                <div class="pointer-events-none absolute rounded-lg inset-0 bg-black opacity-40">
                                </div>
